...
namespace KiwoomRestApi.Net.Examples
{
    public class KiwoomApis
    {
        ...
        public void Run()
        {
			...
			//var a9 = _client.Account.GetDailyStockRealizedProfitLossesAsync("060280", date).Result;
			...
			// 1,4,6,8,10
			//var d1 = _client.Elw.GetBrokerNetTransactionTopsAsync("005", 0, KiwoomElwNetTransactionType.NetBuy, 30, false).Result;
			//var d2 = _client.Elw.GetChangeRateRanksAsync(KiwoomElwSortType.None, KiwoomElwRightsType.All, false).Result;
			//var d3 = _client.Elw.GetConditionSearchsAsync(KiwoomElwCompanyCode.All, "000000000000", KiwoomElwRightsType.All, KiwoomElwCompanyCode.All, KiwoomElwSortType.None).Result;
			//var d4 = _client.Elw.GetDailySensitivityIndicesAsync("060280").Result;
			//var d5 = _client.Elw.GetDisparityRatesAsync(KiwoomElwCompanyCode.All, "000000000000", KiwoomElwRightsType.All, KiwoomElwCompanyCode.All, false).Result;
			//var d6 = _client.Elw.GetLpHoldingDailyTrendsAsync("000000000000", date).Result;
			//var d7 = _client.Elw.GetPriceVolatilitiesAsync(KiwoomElwChangeType.Surge, KiwoomElwTimeType.Day, 1, 0, KiwoomElwCompanyCode.All, "000000000000", KiwoomElwRightsType.All, KiwoomElwCompanyCode.All, false).Result;
			//var d8 = _client.Elw.GetProximityRatesAsync("060280").Result;
			//var d9 = _client.Elw.GetRequestRanksAsync(KiwoomElwSortType2.NetBuyTop, KiwoomElwRightsType.All, false).Result;
			//var d10 = _client.Elw.GetSensitivityIndeicesAsync("060280").Result;
			...
			// 5,6,7,8
			//var i1 = _client.Order.PlaceOrderAsync(KiwoomOrderType.Buy, KiwoomOrderDomesticStockExchangeType.Krx, stockCode, 100, KiwoomOrderTransactionType.Market).Result;
			//var i2 = _client.Order.PlaceOrderAsync(KiwoomOrderType.Sell, KiwoomOrderDomesticStockExchangeType.Krx, stockCode, 50, KiwoomOrderTransactionType.Market).Result;
			//var i3 = _client.Order.ModifyOrderAsync(KiwoomOrderDomesticStockExchangeType.Krx, "113461", stockCode, 5, 12800).Result;
			//var i4 = _client.Order.CancelOrderAsync(KiwoomOrderDomesticStockExchangeType.Krx, "113674", stockCode, 5).Result;
			...
			//var m18 = _client.StockInfo.GetPriceConcentrationsAsync(KiwoomStockInfoMarketType.All, 30, true, 1, 50, KiwoomStockInfoStockExchangeType.Unified).Result;
			...
			List<string> _stockCode = ["005930", "000660", "431190"];
			//
			_client2.WebSocket.SubscribeAsync([
				KiwoomWebSocketServiceName.AfterMarketQuote,
				KiwoomWebSocketServiceName.Balance,
				KiwoomWebSocketServiceName.BestQuote,
				KiwoomWebSocketServiceName.DailyBroker,
				KiwoomWebSocketServiceName.ElwIndicator,
				KiwoomWebSocketServiceName.ElwTheoreticalPrice,
				KiwoomWebSocketServiceName.EtfNav,
				KiwoomWebSocketServiceName.ExpectedTrade,
				KiwoomWebSocketServiceName.IndustryChange,
				KiwoomWebSocketServiceName.IndustryIndex,
				KiwoomWebSocketServiceName.InternationalGoldPrice,
				KiwoomWebSocketServiceName.MarketOpenTime,
				KiwoomWebSocketServiceName.OrderBook,
				KiwoomWebSocketServiceName.OrderTrade,
				KiwoomWebSocketServiceName.ProgramTransaction,
				KiwoomWebSocketServiceName.StockInfo,
				KiwoomWebSocketServiceName.StockTrade,
				KiwoomWebSocketServiceName.StockTrend,
				KiwoomWebSocketServiceName.ViEvent
			], _stockCode, "1").Wait();
			...
			_client2.OnRealtimeAfterMarketQuoteReceived += (e) =>
			{
			};
			_client2.OnRealtimeBalanceReceived += (e) =>
			{
			};
			//_client2.OnRealtimeDailyBrokerReceived += (e) =>
			//{
			//};
			_client2.OnRealtimeElwIndicatorReceived += (e) =>
			{
			};
			_client2.OnRealtimeElwTheoreticalPriceReceived += (e) =>
			{
			};
			_client2.OnRealtimeEtfNavReceived += (e) =>
			{
			};
			_client2.OnRealtimeExpectedTradeReceived += (e) =>
			{
			};
			_client2.OnRealtimeIndustryChangeReceived += (e) =>
			{
			};
			_client2.OnRealtimeIndustryIndexReceived += (e) =>
			{
			};
			_client2.OnRealtimeInternationalGoldPriceReceived += (e) =>
			{
			};
			_client2.OnRealtimeMarketOpenTimeReceived += (e) =>
			{
			};
			
			//_client2.OnRealtimeOrderBookReceived += (e) =>
			//{
			//};
			_client2.OnRealtimeOrderTradeReceived += (e) =>
			{
			};
			//
			//_client2.OnRealtimeProgramTransactionReceived += (e) =>
			//{
			//};
			_client2.OnRealtimeStockBestQuoteReceived += (e) =>
			{
			};
			_client2.OnRealtimeStockInfoReceived += (e) =>
			{
			};
			_client2.OnRealtimeStockTradeReceived += (e) =>
			{
			};
			_client2.OnRealtimeStockTrendReceived += (e) =>
			{
			};
			//
			//_client2.OnRealtimeViEventReceived += (e) =>
			//{
			//};

			_client2.OnConditionSearchClearReceived += (e) =>
			{
			};
			_client2.OnConditionSearchListReceived += (e) =>
			{
			};
			_client2.OnConditionSearchRequestRealtime2Received += (e) =>
			{
			};
			_client2.OnConditionSearchRequestRealtimeReceived += (e) =>
			{
			};
			_client2.OnConditionSearchRequestReceived += (e) =>
			{
			};
		}
